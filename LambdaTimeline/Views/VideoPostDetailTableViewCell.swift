//
//  VideoPostDetailTableViewCell.swift
//  LambdaTimeline
//
//  Created by Craig Swanson on 3/20/20.
...
class VideoPostDetailTableViewCell: UITableViewCell {
    ...
    extension VideoPostDetailTableViewCell: AVAudioPlayerDelegate {
